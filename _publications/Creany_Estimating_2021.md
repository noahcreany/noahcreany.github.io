...
citation: '<strong>Creany, N.</strong>, Monz, C. A., D’Antonio, A., Sisneros-Kidd, A., Wilkins, E. J., Nesbitt, J., & Mitrovich, M. (2021). &quotEstimating trail use and visitor spatial distribution using mobile device data: An example from the nature reserve of orange county, California USA&quot. <i>Environmental Challenges</i>, 4, 100171.
